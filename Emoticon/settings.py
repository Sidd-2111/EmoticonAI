...
# n8n and LLM configuration
ENABLE_N8N_CHAT = os.getenv('ENABLE_N8N_CHAT', 'false').lower() in ('1', 'true', 'yes')
ENABLE_N8N_EMOTION = os.getenv('ENABLE_N8N_EMOTION', 'false').lower() in ('1', 'true', 'yes')
N8N_CHAT_URL = os.getenv('N8N_CHAT_URL', '').strip()
N8N_EMOTION_URL = os.getenv('N8N_EMOTION_URL', '').strip()
N8N_WEBHOOK_SECRET = os.getenv('N8N_WEBHOOK_SECRET', '')

DEFAULT_GEMINI_MODEL = os.getenv('DEFAULT_GEMINI_MODEL', 'gemini-1.0-pro-latest-001')
GEMINI_FALLBACK_MODEL = os.getenv('GEMINI_FALLBACK_MODEL', 'gemini-1.0-mini')
